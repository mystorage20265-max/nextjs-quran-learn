// ServiceNow EXACT Clone - WITH ADVANCED ANIMATIONS
...
const LOGOS = ['Uber', 'Delta', 'Kraft Heinz', 'Mondelēz', 'Dish', 'Visa'];
const SOLUTION_TABS = [
    { id: 'it', label: 'IT', desc: 'Transform IT service management with AI-powered automation', icon: '💻' },
    { id: 'security', label: 'Risk and Security', desc: 'Protect your enterprise with intelligent threat detection', icon: '🛡️' },
    { id: 'hr', label: 'Human Resources', desc: 'Deliver exceptional employee experiences at scale', icon: '👥' },
    { id: 'crm', label: 'CRM', desc: 'Build lasting customer relationships with AI insights', icon: '🤝' },
    { id: 'dev', label: 'App Development', desc: 'Accelerate development with low-code AI tools', icon: '⚡' },
    { id: 'finance', label: 'Finance and Supply', desc: 'Optimize operations with intelligent automation', icon: '📊' }
];
...
export default function DemoPage() {
    ...
    const slides = [
        {
            ...
            subtitle: "for people",
            desc: "Only the ServiceNow AI Platform connects any workflow, any AI, and any data source—so everything and everyone finally works together.",
            primaryBtn: "Explore Platform",
            secondaryBtn: "Watch Video (1:00)",
            bg: "bg-[#002d3d]"
        },
        {
            title: "AI you can trust",
            subtitle: "for business",
            desc: "Scale AI with confidence across your entire enterprise with governance and security built in from the ground up.",
            primaryBtn: "See AI Solutions",
            secondaryBtn: "Read Whitepaper",
            bg: "bg-[#001f2b]"
        }
    ];
    ...
    return (
        <main className="demo-page">
            ...
            {/* ===== NAVBAR - REFINED for official look ===== */}
            ...
            {/* ===== COMPANY LOGOS with reveal ===== */}
            <section className="logos-section reveal-section" ref={logosRef}>
                <h3 className="logos-title animate-child">The world works with ServiceNow</h3>
                <div className="logos-strip">
                    {LOGOS.map((logo, i) => (
                        <span key={logo} className="logo-item animate-child hover-scale" style={{ animationDelay: `${i * 0.1}s` }}>{logo}</span>
                    ))}
                </div>
            </section>
            ...
            <section className="solutions-section reveal-section" ref={solutionsRef}>
                <h2 className="solutions-title animate-child">
                    Run your enterprise on the <span className="green gradient-text">ServiceNow AI Platform</span>
                </h2>
            ...
            <section className="ai-tower-section reveal-section" ref={aiTowerRef}>
                <h2 className="section-title animate-child">
                    <span className="green">Bring intelligence</span> to every corner<br />of your business
                </h2>
                ...
                <div className="infinity-wrapper">
                    ...
                    {/* Left Avatar - Perfectly Centered in left loop (280, 250) */}
                    <div className="infinity-avatar left-loop">
                        ...
                        />
                        <span className="pill-label employees">Employees</span>
                    </div>

                    {/* Right Avatar - Perfectly Centered in right loop (720, 250) */}
                    <div className="infinity-avatar right-loop">
                        ...
                        <img
                            ...
                            className="avatar-face"
                        />
                        <span className="pill-label customers">Customers</span>
                    </div>

                    {/* Center AI AGENTS text at crossing point */}
                    <div className="infinity-label">
                        <span className="ai-main">AI</span>
                        <span className="ai-sub">AGENTS</span>
                    </div>

                    {/* Nodes along the path */}
                    <div className="path-node node-it"><span>IT</span><div className="dot"></div></div>
                    <div className="path-node node-crm"><span>CRM</span><div className="dot"></div></div>
                    <div className="path-node node-hr"><span>Human Resources</span><div className="dot"></div></div>
                    <div className="path-node node-risk"><span>Risk and Security</span><div className="dot"></div></div>
                    <div className="path-node node-dev"><span>App Development</span><div className="dot"></div></div>
                    <div className="path-node node-fin"><span>Finance and Supply</span><div className="dot"></div></div>
            ...
            <section className="testimonials-section reveal-section" ref={testimonialsRef}>
                <h2 className="section-title animate-child">
                    When our customers work, <span className="green">the world works</span>
                </h2>
                <div className="testimonial-cards">
                    <div className="testimonial-card hover-lift-3d animate-child">
                        ...
                        <div className="testimonial-stat glass-stat">
                            <span className="stat-value counter-animate">72%</span>
                            <span className="stat-label">of issues addressed proactively</span>
                        </div>
                    </div>
                    <div className="testimonial-card hover-lift-3d animate-child">
                        <div className="testimonial-image">
                        ...
                        <div className="testimonial-stat glass-stat">
                            <span className="stat-value counter-animate">6x</span>
                            <span className="stat-label">faster resolution time</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="stats-section reveal-section" ref={statsRef}>
                <h3 className="animate-child">Recognized results that transform businesses</h3>
                <div className="stats-grid">
                    {[
                        { num: '#1', text: 'Customer Satisfaction' },
                        { num: '6X', text: 'Faster Delivery' },
                        { num: '4', text: 'Industry Leadership' },
                        { num: '9', text: 'Years of Innovation' }
                    ].map((stat, i) => (
            ...
            <section className="insights-section reveal-section" ref={insightsRef}>
                <div className="insights-header">
                    ...
                    <div className="insights-buttons animate-child">
                        ...
                        <button className="btn-outline hover-fill">View Analyst Reports</button>
                    </div>
                </div>
                ...
                <div className="insights-grid">
                    <div className="insight-featured animate-child gradient-shift">
                        ...
                        <div className="featured-content">
                            ...
                            <h3>Workforce<br />Skills<br />Forecast<br /><span className="year glow-text">2025</span></h3>
                            <a href="#" className="insight-link hover-arrow">Read Forecast <span>→</span></a>
                        </div>
                    </div>

                    {[
                        { badge: 'Gartner®', sub: 'Magic Quadrant™', title: '2025 Gartner® Magic Quadrant™ for CRM', style: 'gartner' },
                        { badge: 'AI', sub: 'ITSM', title: '2025 Gartner® Magic Quadrant™ for AI in ITSM', style: 'ai-itsm' },
                        { badge: 'Enterprise', sub: 'AI Maturity', title: 'Enterprise AI Maturity Index 2025', style: 'maturity' }
                    ].map((card, i) => (
            ...
            <section className="work-section reveal-section" ref={workRef}>
                <div className="work-left">
                    <h2 className="animate-child"><span className="green">Let&apos;s get</span> to work</h2>
                    <p className="animate-child">Explore all the ways ServiceNow can put AI to work for your people.</p>
                </div>
                <div className="work-cards">
                    {[
                        { icon: '👤', title: 'Contact us', desc: 'Talk to an expert and see how a single platform can solve your needs.' },
                        { icon: '👥', title: 'Join the community', desc: 'Learn, share, and connect with people doing work that matters.' },
                        { icon: '🤝', title: 'Find a partner', desc: 'Realize even more value with a ServiceNow partner.' },
                        { icon: '🎬', title: 'Explore demos', desc: 'Get hands-on with the ServiceNow AI Platform.' }
                    ].map((card, i) => (
